You are Mimo CLI. Build the project directly. Do not delegate to another agent or CLI.
...
C:\Users\Admin\Desktop\stock test\open code v5 claude prompt\dumbmoney\agy testing\mimo_parametric_heritage_luxury_indian_lobby_chair
